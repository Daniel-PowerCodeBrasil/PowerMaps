...
> Esse é o mesmo arquivo da versão estável atual (hoje, `1.3.0`). Cada versão
> também fica disponível com o número no nome, ex.: `PowerMaps_HeatMapControl_1_3_0_0_managed.zip`.
